...
#' @param col1 Fill color for the second (outer) HPD inyerval. Default is 'lightblue'.
#' @param pch Point symbol used to display mean posteriors
#' @method plot fittedICAR
#' @export


plot.fittedICAR <- function(x,hpd=c(0.5,0.9),minortick=NULL,ylim=NULL,xlab=NULL,ylab='Probability Mass',calendar='BP',col1='steelblue',col2='lightblue',pch=20)
{
	require(coda)
