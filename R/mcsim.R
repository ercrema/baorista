...
#' @return  An objcect of class \code{mcsimres} containing relevant metadata and a matrix with the number of events per time-block per Monte-Carlo simulation. 
#' @references 
#
